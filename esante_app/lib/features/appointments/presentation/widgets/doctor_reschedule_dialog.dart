...
/// Dialog for doctor to reschedule an appointment
/// Shows date picker and available time slots from doctor's schedule
class DoctorRescheduleDialog extends StatefulWidget {
  final AppointmentEntity appointment;

  const DoctorRescheduleDialog({
    super.key,
  ...
  static Future<void> show(
    ...
    return showModalBottomSheet(
      ...
      builder: (dialogContext) => BlocProvider.value(
        value: context.read<DoctorAppointmentBloc>(),
        child: DoctorRescheduleDialog(appointment: appointment),
      ),
    );
  }

  @override
  State<DoctorRescheduleDialog> createState() => _DoctorRescheduleDialogState();
}

class _DoctorRescheduleDialogState extends State<DoctorRescheduleDialog> {
  ...
  void initState() {
    super.initState();
    // Load doctor's own availability
    _loadAvailability();
  }
    ...
    return BlocListener<DoctorAppointmentBloc, DoctorAppointmentState>(
      listener: (context, state) {
        if (state is DoctorScheduleLoaded) {
          ...
          // Also handle if schedule was updated
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Patient and current appointment info
              Container(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 8.w),
                        AppBodyText(
                          text: widget.appointment.patientInfo?.fullName ?? 'Patient',
                    ...
                    Row(
                      children: [
                        Icon(Icons.event, color: AppColors.grey400, size: 16.sp),
                        SizedBox(width: 8.w),
                        AppSmallText(
                          text:
